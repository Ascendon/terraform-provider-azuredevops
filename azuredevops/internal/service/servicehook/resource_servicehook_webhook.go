...
import (
	...
	"github.com/microsoft/azure-devops-go-api/azuredevops/servicehook"
	"github.com/microsoft/terraform-provider-azuredevops/azuredevops/internal/utils/converter"
	"github.com/microsoft/terraform-provider-azuredevops/azuredevops/internal/utils/tfhelper"
)

// ResourceServiceHookWebHook schema and implementation for web hook service hook resource
func ResourceServiceHookWebHook() *schema.Resource {
	r := genBaseServiceEndpointResource(flattenServiceHookWebHook, expandServiceHookWebHook)
...
func expandServiceHookWebHook(d *schema.ResourceData) (*servicehook.ServiceEndpoint, *string, error) {
	serviceHook, projectID := doBaseExpansion(d)
...
func flattenServiceHookWebHook(d *schema.ResourceData, serviceHook *serviceendpoint.ServiceEndpoint, projectID *string) {
